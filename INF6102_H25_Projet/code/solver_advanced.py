...
def solve_advanced(eternity_puzzle):
    ...
    while time.time() - time_before < TIME_SEARCH_SEC:
        ...
        if initial_solution is None:
            ...
            percentage_of_shuffle = random.uniform(0.001, 0.90)
        ...
        if solver.n_conflicts < best_conflict_count:
            ...
            print("Seed: ", seed)
            print("Iteration ", iteration_count, " best: ", best_conflict_count, " conflicts: ", solver.n_conflicts, " time: ", time.time() - time_start_iter)
